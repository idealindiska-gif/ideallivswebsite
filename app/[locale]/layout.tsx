...
export async function generateMetadata({ params }: LocaleLayoutProps): Promise<Metadata> {
    ...
    if (locale === 'sv') {
        return {
            ...
            icons: {
                icon: [
                    { url: `${siteConfig.site_domain}/favicon.svg?v=3`, type: "image/svg+xml" },
                    { url: `${siteConfig.site_domain}/favicon-32x32.png?v=3`, type: "image/png", sizes: "32x32" },
                    { url: `${siteConfig.site_domain}/favicon-16x16.png?v=3`, type: "image/png", sizes: "16x16" },
                    { url: `${siteConfig.site_domain}/favicon.ico?v=3`, sizes: "any" },
                ],
                shortcut: `${siteConfig.site_domain}/favicon.ico?v=3`,
                apple: [{ url: `${siteConfig.site_domain}/apple-icon.png?v=3`, sizes: "180x180", type: "image/png" }],
            },
            alternates: {
                canonical: `/sv`,
                languages: {
    ...
    if (locale === 'no') {
        return {
            ...
            description: 'Kjøp indiske og pakistanske dagligvarer online i Stockholm. 1500+ produkter med rask levering over hele Sverige og Europa. Basmatiris, krydder, halalkjøtt og mer.',
            keywords: [
                'indisk dagligvarebutikk stockholm',
                'pakistanske dagligvarer sverige',
                'kjøp indiske dagligvarer online',
                'indiske krydder stockholm',
                'halalkjøtt stockholm',
                'basmatiris sverige',
                'indisk mat online',
                'pakistansk mat stockholm',
    ...
    if (locale === 'da') {
        return {
            ...
            description: 'Køb indiske og pakistanske dagligvarer online i Stockholm. 1500+ produkter med hurtig levering over hele Sverige og Europa. Basmatiris, krydderier, halalkød og mere.',
            keywords: [
