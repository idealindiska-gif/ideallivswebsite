...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    icon: [
      { url: `${siteConfig.site_domain}/favicon.svg??v=7`, type: "image/svg+xml" },
      { url: `${siteConfig.site_domain}/favicon-32x32.png??v=7`, type: "image/png", sizes: "32x32" },
      { url: `${siteConfig.site_domain}/favicon-16x16.png??v=7`, type: "image/png", sizes: "16x16" },
      { url: `${siteConfig.site_domain}/favicon.ico??v=7`, sizes: "any" },
    ],
    shortcut: `${siteConfig.site_domain}/favicon.ico??v=7`,
    apple: [{ url: `${siteConfig.site_domain}/apple-icon.png??v=7`, sizes: "180x180", type: "image/png" }],
  },
  verification: {
