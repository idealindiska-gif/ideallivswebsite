...
async function main() {
    // Try broader terms
    await searchAndLog('Jam'); // For Jam-e-Shirin
    await searchAndLog('Alwaid');
    await searchAndLog('Oil'); // Maybe found under generic oil search
    await searchAndLog('Phulki');
    await searchAndLog('Tang');
}
