 ...
 * Brand Configuration
 *
 * Centralized branding for the AI chatbot knowledge base and other components.
 */
...
export const brandConfig = {
  ...
  seo: {
    ...
    keywords: [
      ...
      "halal products stockholm",
      "basmati rice sweden",
      "indian spices stockholm",
      "buy indian groceries online",
      "asian supermarket stockholm",
      "pakistani food stockholm",
      "halal delivery europe",
      "shan foods stockholm",
      "national foods sweden",
      "mdh masala sweden",
      "trs spices stockholm",
      "haldiram snacks europe",
      "india gate basmati stockholm",
      "aashirvaad atta sweden",
      "dabur honey stockholm",
      "rooh afza sweden",
      "laziza desserts stockholm",
      "guard rice sweden",
    ],
  },
} as const;
